      ...
      //x = 30;
        {while (servo1.read() < 90) 
          ...
          servo5.write(x-20);
            ...
            float Rawdis2=SharpIR2.distance();  // this returns the distance to the object you're measuring
            Filtereddis2.Filter(Rawdis2);
            float dis2 = Filtereddis2.Current();
            if (dis2 > 30){
            dis2 = 30;}
       
            float Rawdis3=SharpIR3.distance();  // this returns the distance to the object you're measuring
            Filtereddis3.Filter(Rawdis3);
            float dis3 = Filtereddis3.Current();
            if (dis3 > 60){
            dis3 = 60;}
  
            float Rawdis4=SharpIR4.distance();  // this returns the distance to the object you're measuring
